...
- Name: Prod/prod.put.spec.ts >> Validate PUT Endpoint - Update a user >> PUT - Update user without authentication - Status 401
- Location: tests/Prod/prod.put.spec.ts:249:7
...
```ts
  ...
  172 | 
  173 |     const updateRes = await api.put(`/prod/users/${email1}`, {
  174 |     data: {
