...
- Name: Prod/prod.post.spec.ts >> Validate POST Endpoint - Create user >> POST - Create user with duplicate name - Status 201
- Location: tests/Prod/prod.post.spec.ts:118:7
